...
public class InvitesCommand extends Command {
    ...
    public InvitesCommand() {
        super(Collections.singletonList("invites"), "View your faction invites", "%prefix% &7/f invites", "", true, Duration.ZERO);
    }
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        player.openInventory(new FactionInvitesGUI(user.getFaction()).getInventory());
        return true;
    }
