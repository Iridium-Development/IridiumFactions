...
public class AllyCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        Optional<FactionRelationshipRequest> factionRelationshipRequest = IridiumFactions.getInstance().getFactionManager().getFactionRelationshipRequest(user.getFaction().get(), faction.get(), RelationshipType.ALLY);
        if(factionRelationshipRequest.isPresent()){
            factionRelationshipRequest.get().accept(user);
        }else{
            IridiumFactions.getInstance().getDatabaseManager().getFactionRelationshipRequestTableManager().addEntry(new FactionRelationshipRequest(user.getFaction().get(), faction.get(), RelationshipType.ALLY, user));
