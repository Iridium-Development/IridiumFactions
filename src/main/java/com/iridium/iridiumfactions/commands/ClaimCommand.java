...
public class ClaimCommand extends Command<Faction, User> {

    public ClaimCommand() {
        super(Collections.singletonList("claim"), "Claim land for your faction", "%prefix% &7/f claim (size) (faction)", "", 0);
    }
